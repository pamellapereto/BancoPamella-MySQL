...
insert into usuarios (usuario,login,senha,perfil)
values ('José de Assis', 'josedeassis',md5('654321'),'user');
...
insert into  fornecedores (cnpj,razao,fantasia, site, fone, contato, email, cep,endereco,numero,bairro,cidade,uf)
values ('71.345.649/0001-77','Evandro Ramos','Shein', 'www.shein.com', '(11) 94216-7915', 'Andreza Martins', 'shein@contato.com.br', '04319-100','Rua Martins','4090','Vila Granada','Rio de Janeiro','RJ');

insert into  fornecedores (cnpj, ie, im, razao,fantasia,fone,cep,endereco,numero, complemento, bairro,cidade,uf)
values ('34.246.213/0001-11', '88448866-88', '12347764-31', 'Joaquim Silva','C&A','(21) 94369-0164','14296-022','Avenida Brasil','942', 'Portaria 4', 'Jardim Oliveiras','Americana','SP');

insert into  fornecedores (cnpj, ie, im, razao,fantasia,fone,cep,endereco,numero,bairro,cidade,uf, obs)
values ('96.941.346/0001-99', '34797751-42', '07199723-14', 'Adriana Calcanhoto','Renner','(22) 97516-9463','02796-010','Avenida Monteiro Lobato','15','Vila Albertina','Salvador','BA', 'Fornecedor estrangeiro (pagamento em dólar)');
...
values ('1111111111','blusa','verde','Estilo Confecções',20,5,'UN','Setor Blusas',59.90,65/100,1);

insert into produtos (barcode,produto,descricao,fabricante,estoque,estoquemin,unidade,localizacao,custo,lucro,idfor)
values ('2222222222','vestido','amarelo','Estilo Confecções',14,9,'UN','Setor Vestidos',39.90,50/100,1);

insert into produtos (barcode,produto,descricao,fabricante,estoque,estoquemin,unidade,localizacao,custo,lucro,idfor)
values ('3333333333','cropped','azul','Estilo Confecções',19,13,'UN','Setor Blusas',99.90,100/100,1);

insert into produtos (barcode,produto,descricao,fabricante,estoque,estoquemin,unidade,localizacao,custo,lucro,idfor)
values ('4444444444','calça','branca','Altamoda',7,10,'UN','Setor Calças',33.90,100/100,2);

insert into produtos (barcode,produto,descricao,fabricante,estoque,estoquemin,unidade,localizacao,custo,lucro,idfor)
values ('5555555555','vestido','listrado','Altamoda',9,12,'UN','Setor Vestidos',49.90,70/100,2);
